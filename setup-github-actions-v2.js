...
// Create CI/CD workflow file with Node.js 24 support
...
const prTemplatePath = path.join(__dirname, '.github', 'pull_request_template.md');
...
console.log('   ✅ Node.js 24 compatible');
